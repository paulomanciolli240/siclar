...
function resolverUrlImagem(valFoto) {
    ...
    /*
      Fotos locais do SICLAR ficam na pasta imagens/.
      Nomes numéricos como imagens/1262.png são permitidos.
      A existência real da foto é controlada pelo salvo-conduto
      do carrossel, evitando requisições para arquivos inexistentes.
    */
    const caminho = valor
        .replace(/\\/g, "/")
        .replace(/^\.\//, "");
